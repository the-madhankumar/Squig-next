...
export function Footer() {
  ...
  return (
    <div className="flex flex-row items-center justify-center w-full">
      <div className="w-full text-center mx-auto relative overflow-hidden h-full md:h-[40rem] px-4">
        {/* <motion.div
        ...
        > */}
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mt-5">
